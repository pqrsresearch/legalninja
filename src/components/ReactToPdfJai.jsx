...
class ReactToPdfJai extends PureComponent {
  constructor(props) {
    super(props);
  ...
  toPdf() {
    ...
    html2canvas(targetComponent, {
      ...
      let imgHeight = (canvas.height * this.imgWidth) / canvas.width;
      let heightLeft = imgHeight;
      let doc = new JsPdf(options);
      let position = 0;

      doc.addImage(imgData, 'PNG', 0, position, this.imgWidth, imgHeight);
